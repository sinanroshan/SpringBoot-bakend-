...
public interface CompanyDataRrepository extends JpaRepository<CompanyData, Any>{
    ...
    @Modifying
	@Transactional
    @Query(value="Update company SET cmp_add1=:address1,cmp_add2=:address2,cmp_phone=:phone,cmp_mail=:email,cmp_site=:website,cmp_gstno=:gstNo,cmp_city=:city,cmp_state=:state,cmp_country=:country,cmp_bname=:bank,cmp_bbranch=:bankBranch,cmp_bifsc=:bankIfce,cmp_baccountno=:bankAccNO,cmp_logo=:Logo,cmp_name =:name", nativeQuery = true)
